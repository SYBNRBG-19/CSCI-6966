module Infer (inferTypes, canonicalize, substType, collectTVars, renameTVars) where
...
-- Updated prettyPrintType function
prettyPrintType :: Type -> String
prettyPrintType ty = ppType ty False
  where
    ppType (TBase bt) _ = show bt  -- This will output "BTBool" or "BTInt"
    ppType (TVar v) _ = v
